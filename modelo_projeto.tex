...
A Clinica Médica Santa Rita consta atualmente com 5 computadores em um prédio de ????? metros quadrados

Esta com rede instavel e precisa de uma reestruturação 

 ..Sera substituida a rede com cat6 

O escopo deste projeto visa apenas a instalação física
...
O principal benefício da reestruturação da rede será a estabilidade física da rede provendo redução nos custos de manutenção visto que hoje ela sofre grandes prejuízos devido a instabilidade. 

Outro grande benefício será possibilidade de ampliação da rede.
...
---------anotações----------
A compra dos materiais utilizados sera terceirizada para 
---------anotações----------
...
\begin{itemize}
	...
	---------anotações----------
	Instabilidade da rede deixando os softwares utilizados para agendamento de consultas inoperantes 
	
	Não podendo agendar consultas nem buscar o histórico dos funcionários.
	---------anotações----------
	...
	tubulação mal feita cabos dobrados
	switch em defasagem 
...
\begin{itemize}
	\item Utilização do software Clinic precisa pelo menos core i3 nas maquinas para rodas..
...
Os usuários da Clinica Médica são três grupos.
\begin{itemize}
	\item 2 Médicos.
	\item 4 Enfermeiros.
...
\begin{itemize}
	\item Médicos: Utilização do software Clinic consultar o prontuário do paciente e internet.
...
---------anotações----------
Qual o estados?
tem caminhos para os cabos?
eletrocalha passada?


Rever a engenharia para passagem correta dos cabos.
---------anotações----------
