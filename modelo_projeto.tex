...
A Clinica Médica XYZ consta atualmente com 4 computadores, 2 notebooks e uma tv conectada a internet em um prédio de 100 metros quadrados. Atualmente, encontra-se com a rede instável e precisa de uma reestruturação. Sera substituída a rede com o cabo cat6 e colocado rede sem fio. O escopo deste projeto visa apenas a instalação física.
...
A estrutura predial atual estava defasada. Segunda a figura \ref{XYZ}, será necessário trocar toda a tubulação para passagem dos novos cabos e para alcançar os pontos da rede. O projeto visa o uso correto dos cabos sendo somente o necessário para o estado desejado e para um possível aumento dos nós na rede no futuro, se desejado.
